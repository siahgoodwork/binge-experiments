  ...
  return (
    <group>
      ...
      <group>
        ...
        <AudioSrc ref={audioObj1Ref} position={[0, 1, -7]} />
        <AudioSrc ref={audioObj2Ref} position={[-2, 1, 7]} />
        <AudioSrc ref={audioObj3Ref} position={[11, 1, -4]} />
        <AudioSrc ref={audioObj4Ref} position={[11, 1, 7]} />
        <AudioSrc ref={audioObj5Ref} position={[4, 1, 7]} />
      </group>
